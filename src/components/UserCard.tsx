...
<div className="flex flex-col justify-between h-full p-4 space-y-3 transition-colors bg-white shadow-md dark:bg-gray-800 rounded-xl">
  ...
  <div className="flex justify-end gap-2">
    <button className="bg-[#3251D0] dark:bg-blue-600 px-4 py-2 rounded text-white">Edit</button>
    <button className="px-4 py-2 text-white bg-red-500 rounded">Delete</button>
  </div>
</div>
